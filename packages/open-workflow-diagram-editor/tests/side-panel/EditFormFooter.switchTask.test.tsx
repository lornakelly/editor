 ...
 *
 * `switch` is the first array the panel edits. `flattenTask` collapses an array
 * to a single key, so however many cases the user touches, one value carrying
 * the whole list reaches `applyDirtyValues` — these tests pin down that the
 * untouched cases survive that round trip intact.
 */
