...
describe("React Flow custom node types", () => {
  ...
  describe("should render terminal nodes with TerminalNodeContent", () => {
    ...
    it.each(terminalNodes)(
      "renders $testId node as a neutral pill with its translated label",
      ({ id, type, testId, handleType }) => {
        ...
        // shows the uniform translated label, not the node's raw data.label
        ...
        // only the one relevant handle is rendered (entry → source, exit → target)
