...
function buildReactFlowNode(
  ...
  // Entry/exit are structural markers with no inspectable data — make them fully inert so they
  // don't offer a selection/drag affordance that leads nowhere (the side panel has nothing to show).
